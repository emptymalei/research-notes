...
html_theme_options = {
   ...
   'description': 'Neutrino Physics Notebook',
}
...
project = u'Neutrino Private Notebook'
...
html_title = 'Neutrino Private Notebook'
...
htmlhelp_basename = 'NeutrinoPrivatedoc'
...
latex_documents = [
  ('index', 'neutrino-private.tex', u'Neutrino Private Notebook',
   u'Lei Ma', 'manual'),
]
...
man_pages = [
    ('index', 'neutrino', u'Neutrino Private Notebook',
     [u'Lei Ma'], 1)
]
