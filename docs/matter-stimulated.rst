...
We continue to rewrite the Hamiltonian by combining all terms. First of all, we write down the general form of Hamiltonian 12 element for :math:`N` frequencies which is similar to :eq:`stimulated-multi-freq-hamiltonian-12-element`,
